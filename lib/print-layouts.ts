    ...
    ? value.itemRows
        .map((row, rowIndex) => {
          ...
          return {
            ...
            ...(typeof v.dataKey === "string" ? { dataKey: v.dataKey as PrintDataKey } : {}),
            ...(typeof v.leftDataKey === "string" ? { leftDataKey: v.leftDataKey as PrintDataKey } : {}),
            ...(typeof v.rightDataKey === "string" ? { rightDataKey: v.rightDataKey as PrintDataKey } : {}),
            ...(typeof v.columnSeparator === "string" ? { columnSeparator: v.columnSeparator } : {}),
            ...(typeof v.text === "string" ? { text: v.text } : {}),
            ...(typeof v.leftText === "string" ? { leftText: v.leftText } : {}),
            ...(typeof v.rightText === "string" ? { rightText: v.rightText } : {}),
            ...(Number.isFinite(v.tabCount) ? { tabCount: Math.max(0, Math.min(12, Number(v.tabCount))) } : {}),
            ...(Number.isFinite(v.leftTabCount) ? { leftTabCount: Math.max(0, Math.min(12, Number(v.leftTabCount))) } : {}),
            ...(Number.isFinite(v.rightTabCount) ? { rightTabCount: Math.max(0, Math.min(12, Number(v.rightTabCount))) } : {}),
            ...(typeof v.prefix === "string" ? { prefix: v.prefix } : {}),
            ...(typeof v.suffix === "string" ? { suffix: v.suffix } : {}),
            ...(typeof v.leftPrefix === "string" ? { leftPrefix: v.leftPrefix } : {}),
            ...(typeof v.leftSuffix === "string" ? { leftSuffix: v.leftSuffix } : {}),
            ...(typeof v.rightPrefix === "string" ? { rightPrefix: v.rightPrefix } : {}),
            ...(typeof v.rightSuffix === "string" ? { rightSuffix: v.rightSuffix } : {}),
            ...(VALID_ALIGNS.has(v.align as PrintAlign) ? { align: v.align as PrintAlign } : {}),
            ...(VALID_SIZES.has(v.size as QzTextSizePreset) ? { size: v.size as QzTextSizePreset } : {}),
            ...(typeof v.bold === "boolean" ? { bold: v.bold } : {}),
            ...(VALID_ALIGNS.has(v.leftAlign as PrintAlign) ? { leftAlign: v.leftAlign as PrintAlign } : {}),
            ...(VALID_ALIGNS.has(v.rightAlign as PrintAlign) ? { rightAlign: v.rightAlign as PrintAlign } : {}),
            ...(VALID_SIZES.has(v.leftSize as QzTextSizePreset) ? { leftSize: v.leftSize as QzTextSizePreset } : {}),
            ...(VALID_SIZES.has(v.rightSize as QzTextSizePreset) ? { rightSize: v.rightSize as QzTextSizePreset } : {}),
            ...(typeof v.leftBold === "boolean" ? { leftBold: v.leftBold } : {}),
            ...(typeof v.rightBold === "boolean" ? { rightBold: v.rightBold } : {}),
          } satisfies PrintItemTemplateRow;
        })
        .filter((row): row is PrintItemTemplateRow => row !== null)
    : undefined;
  return {
